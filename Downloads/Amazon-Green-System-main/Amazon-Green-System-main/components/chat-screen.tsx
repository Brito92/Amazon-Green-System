    ...
    messages: [
      {
        ...
        avatar: "ST",
        content:
          "Olá! Aqui é o suporte técnico do Sistema Verde da Amazônia. Em que posso ajudar?",
        time: "09:40",
        isOwn: false,
      },
      {
        ...
        avatar: "ST",
        content:
          "Pode relatar o problema ou dúvida e envio para a equipe responsável.",
        time: "09:42",
        isOwn: false,
      },
    ],
    ...
    messages: [
      {
        ...
        avatar: "MS",
        content:
          "Olá pessoal! Alguém tem dicas sobre o cultivo de Açaí em área de várzea?",
        time: "10:25",
        isOwn: false,
      },
      {
        ...
        avatar: "JS",
        content:
          "Na várzea é importante cuidar da drenagem. O Açaí gosta de umidade mas não de encharcamento constante.",
        time: "10:27",
        isOwn: false,
      },
      {
        ...
        avatar: "EU",
        content:
          "Eu uso cobertura morta para ajudar a regular a umidade. Funciona muito bem!",
        time: "10:28",
        isOwn: true,
      },
    ],
...
export function ChatScreen() {
  ...
  const selectedConversation = useMemo(
    () =>
      conversations.find(
        (c) => c.id === selectedId && c.category === activeCategory
      ) ?? conversationsByCategory[0],
    [selectedId, activeCategory, conversationsByCategory]
  )
  ...
  const handleSendMessage = (e: React.FormEvent) => {
    ...
    // Não permite enviar mensagens em produtos vendidos (chat de compras)
    if (
      selectedConversation.product?.status === "vendido" &&
